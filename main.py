# main.py — Generated by VIA for: Build me a habit tracker with streaks, progress charts and daily reminders with beautiful modern UI using only inline CSS styles, no tailwind, no external CSS libraries
...
app = FastAPI(
    title="Build Me A Habit Tracker With",
...
@app.get("/")
def root():
    return {"app": "Build Me A Habit Tracker With", "status": "running", "generated_by": "VIA"}
