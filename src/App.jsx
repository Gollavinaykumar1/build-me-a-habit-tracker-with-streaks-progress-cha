// src/App.jsx — Generated by VIA for: Build me a habit tracker with streaks, progress charts and daily reminders with beautiful modern UI using only inline CSS styles, no tailwind, no external CSS libraries
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="font-display font-bold text-gray-900 text-lg">Build Me A Habit Tracker With Streaks Progress</span>
            </Link>
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-3xl font-display font-bold text-gray-900">Build Me A Habit Tracker With Streaks Progress</h1>
